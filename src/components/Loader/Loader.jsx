  ...
  return (
    <AnimatePresence>
      {visible ? (
        <motion.div
          key="intro-scene"
          className="fixed inset-0 flex flex-col items-center justify-center w-full h-full text-black origin-top transform pointer-events-none z-loader bg-gray-e3 md:h-screen md:min-h-screen"
          initial={{
            // scaleY: 1,
            opacity: 0,
          }}
